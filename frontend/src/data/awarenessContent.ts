 ...
 *   Professor Messer, Computerphile, SANS, CISA, NIST). Direct watch URLs link to
 *   specific curated videos on each topic.
 *
...
export const AWARENESS_VIDEOS: Record<string, VideoRef> = {
  ...
  password_security: {
    ...
    url: 'https://www.youtube.com/watch?v=GbHadmblMGk',
    duration: '10 min',
  },
  mfa_explained: {
    title: { en: 'What Is Multi-Factor Authentication?', ar: 'ما هي المصادقة متعددة العوامل؟' },
    channel: 'IBM Technology',
    url: 'https://www.youtube.com/watch?v=rft0AvPkZr4',
    duration: '7 min',
  },
  passphrases: {
  ...
  safe_browsing: {
    ...
    url: 'https://www.youtube.com/watch?v=YSwTfealIV4',
    duration: '11 min',
  },
  data_protection: {
