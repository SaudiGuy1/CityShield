...
from generator import IoTGenerator
...
# Configuration
LOG_FILE_PATH = "/data/logs/iot_sim.jsonl"
EVENT_RATE = float(os.getenv("EVENT_RATE", "3"))  # Events per second
OPENSEARCH_URL = os.getenv("OPENSEARCH_URL", "http://opensearch:9200")
OPENSEARCH_INDEX = "logs-iot"
...
def simulation_loop():
    ...
    logger.info("Starting IoT sensor simulation loop...")
...
logger.info("IoT sensor simulator started")
